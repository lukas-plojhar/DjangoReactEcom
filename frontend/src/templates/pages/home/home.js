...
export default class home extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <TopNav />
        <div className="product-container white-bg">
          <div className="container">
            <div className="product-content d:flex flex:col md:flex:row">
              <div className="product-details d:grid">
                <div className="content">
                  <h1 className="mobile-center mt-3 pt-3">
                    Chceš úsměv jako hollywoodská hvězda?
                  </h1>
                  <p className="mobile-center">
                    Vrať svým zubům jejich přirozenou bělost a pevnost.
                    Jednoduše, rychle a za pár korun.
                  </p>
                  <div className="row">
              ...
              <div className="product-img">
                ...
                <div className="badge-overlay">
                  <img src="https://i2.wp.com/wcdemo.mergadoshop.com/wp-content/uploads/2020/03/overeno_zakazniky_gold_1.png" />
                </div>
              </div>
            </div>
          </div>
