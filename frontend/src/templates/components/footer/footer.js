        ...
        <div className="container">
          <div className="footer-content d:grid">
            ...
            <div className="partners m-1 text-center">
              <img src="https://onas.heureka.cz/upload/221-logoheurekanoclaim.png" className="partner-logo"/>
              <img src="https://iczc.cz/qdir6885maub2i7ag57an6b6f6_m/obrazek" className="partner-logo"/>
              <img src="https://ceskedluhopisy.cz/wp-content/uploads/2019/11/logo-alza.png" className="partner-logo"/>
            </div>
