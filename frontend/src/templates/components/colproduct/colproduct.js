...
class SingleColProduct extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            description: "Získej bílé zuby jako z plakátu – jednoduše, bez bolesti a za pouhých 30 minut. Bělicí\n" +
            ...
            content: "Balení obsahuje: 14x horní pásek, 14x dolní pásek, stupnici pro kontrolu bělosti, návod\n" +
    ...
    render() {
        const {id, name, description, content, featuredImage, selectedVariation, rating, numberOfReviews, variations} = this.state;
        return (
            <div className="product d:grid">
                ...
                <div className="star-review d:flex flex:row">
                    ...
                    <span className="rv-span">({rating}) {numberOfReviews}x</span>
                </div>
                <p>
                    {description}
                </p>
