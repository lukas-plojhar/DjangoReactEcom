    ...
    handleSubmit = async event => {
        ...
        stripe.confirmCardPayment(clientSecret, {
            ...
            if (result.error) {
                ...
                // Succesful payment
            } else if (result.paymentIntent.status === 'succeeded') handleOrder(event);
        });
...
export const InjectedStripeGatewayForm = ({total, isDisabled, handleOrder}) => {
    return (
        <Elements stripe={stripePromise}>
            <ElementsConsumer>
                {
                    ({stripe, elements}) => (
                        <StripeGateway stripe={stripe}
                                       elements={elements}
                                       total={total}
